import MainNav from "@/components/public/header/main-nav";
import {MobileNav} from "@/components/public/header/mobile-nav";
import AuthNav from "@/components/public/header/auth-nav";
